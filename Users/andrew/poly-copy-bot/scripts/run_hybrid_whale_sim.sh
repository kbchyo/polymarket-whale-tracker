...
# Hybrid paper-sim instance: combines ws-triggered flow + activity/trade reconciliation.
export WHALE_ADDRESSES="0x63ce342161250d705dc0b16df89036c8e5f9ba9a"
export LIVE_TRADING="false"
export FEED_MODE="hybrid"
export POLL_MS="2000"
export STATE_FILE=".state/bot-state.hybrid-whale.json"

# Hybrid tuning from your bot + friend's bot ideas (moderately aggressive).
...
export MARKET_POSITION_CAP_USDC="25"
...
# PnL-balanced hybrid speed profile.
